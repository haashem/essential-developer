...
//  EssentialFeedTests
//
//  Created by Hashem Aboonajmi on 8/8/20.
...
class CodableFeedStore {
    ...
    func insert(_ feed: [LocalFeedImage], timestamp: Date, insertionCompletion: @escaping FeedStore.InsertionCompletion) {
...
class CodableFeedStoreTests: XCTestCase {
    ...
    private func makeSUT(storeURL: URL? = nil, file: StaticString = #file, line: Int = #line) -> CodableFeedStore {
    ...
    func expect(_ sut: CodableFeedStore, toRetrieve expectedResult: RetrieveCachedFeedResult, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.retrieve{ retrievedResult in
            switch (retrievedResult, retrievedResult) {
            case (.empty, .empty),
                 (.failure, .failure):
                break
