...
class CacheFeedImageDataUseCaseTests: XCTestCase {
    ...
    private func expect(sut: LocalFeedImageDataLoader, toCompleteWithResult expectedResult: LocalFeedImageDataLoader.SaveResult, when action: () -> Void, file: StaticString = #filePath, line: UInt = #line) {
