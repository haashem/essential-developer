...
//  EssentialFeediOS
//
//  Created by Hashem Abounajmi on 01/02/2022.
...
final class FeedImagePresenter<View: FeedImageView, Image> where View.Image == Image {
    ...
    func didStartLoadingImageData(for model: FeedImage) {
        self.view.display(FeedImageViewModel(description: model.description, location: model.location, image: nil, isLoading: true, shouldRetry: false))
    }
